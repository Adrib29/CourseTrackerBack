...
public class EtapeControler {
	 ...
	 */
	@GetMapping("/parcours/{parcoursId}/etape/{etapeId}")
	public Etape getEtape(@PathVariable("parcoursId") final Long parcoursId, @PathVariable("etapeId") final Long etapeId) {
